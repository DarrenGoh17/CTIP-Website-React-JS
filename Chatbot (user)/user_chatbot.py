...
os.environ['GOOGLE_API_KEY'] = 'AIzaSyD4W_Zskr4rJJF2xkWODQ0qDCAAj-sdH2c'
...
def load_index_and_metadata():
    index = faiss.read_index("C:\\Users\\darre\\OneDrive\\Documents\\Computing Technology Innovation Project\\React JS\\Semenggoh Website\\Semenggoh Website\\Chatbot (user)\\web_index_faiis.bin")
    faiss_ids = np.load("C:\\Users\\darre\\OneDrive\\Documents\\Computing Technology Innovation Project\\React JS\\Semenggoh Website\\Semenggoh Website\\Chatbot (user)\\faiss_ids_web.npy", allow_pickle=True)
    descriptions = np.load("C:\\Users\\darre\\OneDrive\\Documents\\Computing Technology Innovation Project\\React JS\\Semenggoh Website\\Semenggoh Website\\Chatbot (user)\\descriptions_web.npy", allow_pickle=True)
...
def generate_user_friendly_response(question, faiss_results):
    ...
    context = (
        "You are a knowledgeable assistant for Sarawak Forestry Corporation website, providing clear, accurate, and concise answers to visitors' questions. "
