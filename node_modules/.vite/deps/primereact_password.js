...
import {
  IconBase
} from "./chunk-DFDHTR66.js";
import {
  InputText
} from "./chunk-PB2GNFJN.js";
import {
  ComponentBase,
  DomHandler,
...
var EyeIcon = React6.memo(React6.forwardRef(function(inProps, ref) {
...
var EyeSlashIcon = React7.memo(React7.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
  return React7.createElement("svg", _extends3({
    ref,
    width: "14",
    height: "14",
    viewBox: "0 0 14 14",
...
var IconField = import_react6.default.memo(import_react6.default.forwardRef(function(inProps, ref) {
  var elementRef = (0, import_react6.useRef)(ref);
  var mergeProps = useMergeProps();
  var context = (0, import_react6.useContext)(PrimeReactContext);
  ...
  return import_react6.default.createElement("div", _extends4({}, rootProps, {
    ref: elementRef
  }), import_react6.Children.map(props.children, function(child, index) {
...
var InputIcon = import_react6.default.memo(import_react6.default.forwardRef(function(inProps, ref) {
  var elementRef = (0, import_react6.useRef)(ref);
  var mergeProps = useMergeProps();
  var context = (0, import_react6.useContext)(PrimeReactContext);
  ...
  return import_react6.default.createElement(import_react6.default.Fragment, null, import_react6.default.createElement("span", _extends4({}, rootProps, {
    ref: elementRef
  }), props.children));
}));
...
var Password = React8.memo(React8.forwardRef(function(inProps, ref) {
  ...
  var createIcon = function createIcon2() {
    ...
    if (unmaskedState) {
      icon2 = props.hideIcon || React8.createElement(EyeSlashIcon, hideIconProps);
    } else {
      icon2 = props.showIcon || React8.createElement(EyeIcon, showIconProps);
    }
  ...
  var createPanel = function createPanel2() {
    ...
    var content = props.content ? ObjectUtils.getJSXElement(props.content, props) : React8.createElement(React8.Fragment, null, React8.createElement("div", meterProps, React8.createElement("div", meterLabelProps)), React8.createElement("div", infoProps, infoTextState));
    ...
    var panel3 = React8.createElement(CSSTransition2, _extends4({
      nodeRef: overlayRef
    }, transitionProps), React8.createElement("div", _extends4({
      ref: overlayRef
  ...
  var input2 = React8.createElement(InputText, inputTextProps);
  if (icon) {
    input2 = React8.createElement(IconField, {
      className: cx("iconField"),
      pt: ptm("iconField"),
      __parentMetadata: {
        parent: metaData
      }
    }, input2, React8.createElement(InputIcon, null, icon));
  }
  return React8.createElement("div", rootProps, input2, panel2);
}));
